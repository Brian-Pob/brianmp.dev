...
Zed is all about helping you *"code at the speed of thought"*. So it's got a bunch of cool out-of-the-box tools like Vim, LSP, Tree-sitter, an integrated terminal, and GitHub Copilot. All these features being baked into Zed help you code as efficiently as you possibly can. It also support features for languages and frameworks like TypeScript and Astro!
