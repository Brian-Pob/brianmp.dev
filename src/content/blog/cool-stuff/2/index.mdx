...
Zed is all about helping you *"code at the speed of thought"*. So it's got a bunch of cool 
out-of-the-box features that help you write code as efficiently as you can.
This includes native support for tools like Vim, LSP, Tree-sitter, an 
integrated terminal, and GitHub Copilot.
They also have support for languages and frameworks like TypeScript and Astro!
